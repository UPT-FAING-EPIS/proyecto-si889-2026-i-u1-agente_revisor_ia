...
### Despliegue en GitHub Pages (frontend estático)

El frontend se puede exportar a estático y publicar en GitHub Pages. El backend FastAPI y Supabase
...
2. En GitHub Actions define:
   - `NEXT_PUBLIC_BACKEND_URL` con la URL pública del backend.
